...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-white ms-2" href="index.php">
                <img src="./icones/icone-contact.png" width="30" height="30" class="d-inline-block align-top"> Contacts List
            </a>
    ...
    <main>
        <div class="d-flex justify-content-center align-items-center">
            <div class="bg-white p-5 m-5 w-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Contacts</h2>
                    <a class="text-decoration-none text-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Contact</a>
                    <!-- Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="px-4 py-3" id="form">
                                    <form method="POST" class="text-muted row g-3 needs-validation" >
                                        ...
                                        <div class="col-12 m-3 modal-footer text-center">
                                            <button class="btn btn-warning" name="save" type="submit">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="py-4">
                        ...
                        <?php if (!empty($res)) { foreach($res as $rows){?>
                            ...
                            <div class="row my-3 item">
                                ...
                                <p class="col-sm-1 mb-0 p-1"><a class="text-decoration-none btn-edit text-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModaledit">Edit</a></p>
                                <p class="col-sm-1 mb-0 p-1">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModaldelete" class="text-decoration-none text-warning" >Delete</a></p>
                            </div>
                        ...
                        <div class="modal fade" id="exampleModaldelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="px-4 py-3">
                                        <a class="text-decoration-none text-warning" href="action.php?id=<?= $rows['id_contact']?>&req=delete">Yes, Delete this contact please</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="px-4 py-3" id="form">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-12 mt-3 modal-footer text-center">
                                                ...
                                                <input type="submit" value='Update Contact'class="btn btn-warning" ></input>
                                            </div>
                                        </form>
                                    </div>
                                </div>
