...
<body>
    ...
    <main>
        <div class="d-flex justify-content-center align-items-center">
            <div class="bg-light border border-warning p-5 m-4 w-50 mt-5">
                <form method="post" onsubmit="return validation()" novalidate>
                    ...
                    <div class="m-3">
                        <button class="w-100 btn btn-warning" name="signup" type="submit">Sign Up</button>
                    </div>
                    <div class="m-3">
                        <p>Already have an account? <a class="text-decoration-none text-warning" href="login.php">Log In</a> here.</p>
                    </div>
                </form>
            </div>
        </div>
